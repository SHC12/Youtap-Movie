class DetailTv {
  ...
  DetailTv.fromJson(Map<String, dynamic> json) {
    ...
    name = json['name'];
    nextEpisodeToAir = json['next_episode_to_air'] != null ? new LastEpisodeToAir.fromJson(json['next_episode_to_air']) : null;
    ...
    type = json['type'];
    voteAverage = double.parse(json['vote_average'].toString()).floor();
...
class LastEpisodeToAir {
  ...
  LastEpisodeToAir({this.airDate, this.episodeNumber, this.id, this.name, this.overview, this.productionCode, this.seasonNumber, this.voteAverage, this.voteCount});
